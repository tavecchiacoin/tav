...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def test_tool_wallet_info(self):
        ...
        # assert self.wallet_permissions() in ['400', '666'] # Sanity check. 666 is for on Windows.
        ...
        assert self.wallet_permissions() in ['600', '666']  # Sanity check. 666 is for on Windows.
        #
