...
inline uint64_t MaxOptimalLinearizationIters(DepGraphIndex cluster_count)
{
    ...
    static constexpr uint64_t ITERS[65] = {
        0,
        0, 413, 721, 1319, 2195, 3446, 4792, 7135,
        8247, 9999, 12359, 17234, 18011, 23076, 25101, 28798,
        37024, 42019, 50090, 51380, 64472, 56722, 85284, 86352,
        103457, 112270, 117921, 129802, 140282, 147654, 174490, 182959,
        186333, 202808, 215499, 226465, 230857, 199072, 225752, 321360,
        293112, 265782, 369537, 448217, 481423, 519737, 520894, 515393,
        533759, 409641, 548941, 593861, 643538, 491076, 647522, 505566,
        541546, 923157, 658847, 638233, 665002, 811056, 985044, 1029456
    };
