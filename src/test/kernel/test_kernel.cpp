...
BOOST_AUTO_TEST_CASE(logging_tests)
{
    ...
    logging_set_level_category(btck::LogCategory::BENCH, LogLevel::TRACE_LEVEL);
    ...
    {
        logging_set_level_category(btck::LogCategory::KERNEL, LogLevel::TRACE_LEVEL);
...
//
// Uses hard-coded transaction hex from src/test/data/tx_invalid.json (marked
// "BADTX") and tx_valid.json. CheckTransaction performs only basic context-free
...
// not reachable through btck_check_transaction.
// -----------------------------------------------------------------------------
