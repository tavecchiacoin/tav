...
FUZZ_TARGET(block_template_cache, .init = initialize_block_template_cache)
{
    ...
    node.validation_signals->BlockConnected(/*role=*/{true, false}, /*block=*/nullptr, /*pindex=*/nullptr);
    ...
    LIMITED_WHILE(fuzzed_data_provider.remaining_bytes(), 10)
    {
        ...
        node.validation_signals->BlockConnected(background_role, /*block=*/nullptr, /*pindex=*/nullptr);
        ...
        node.validation_signals->BlockConnected(normal_role, /*block=*/nullptr, /*pindex=*/nullptr);
