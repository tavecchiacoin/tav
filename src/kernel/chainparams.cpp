...
{
    const char* pszTimestamp = "The Times 10/Mar/2026 TVNET launches the decentralized video internet";
...
public:
    CMainParams() {
      ...
      pchMessageStart[3] = 0x31;
       ...
       genesis = CreateGenesisBlock(1773100800, 29843, 0x1f00ffff, 1, 20 * COIN);
       consensus.hashGenesisBlock = genesis.GetHash();
       assert(consensus.hashGenesisBlock == uint256S("000030b9427318435c7d6b84a0c45b7f9bc7f088a24601879b0eee8f4fc1a646"));
       assert(genesis.hashMerkleRoot == uint256S("b769937014c34f10f80294c6648486ab1e22ba416cb1680c8075b47e3803fb82"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x54, 0x41, 0x56};
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x54, 0x41, 0x57};
